...
function App() {
  ...
  return (
    <>
      ...
      <Contact />
      <h2 className='crouselh2'>Read Our Customer Testimonials</h2>
      <p className='crouselPara'>Our clients are our partners and we can not imagine a better future for our <br></br> company without helping them reach their objectives</p>
